...
Know and Relate, networking with key decision makers. Gather Data

### Who is buying?
### Where are they from?
### When to they buy?
### How did they find out?
Sales Channel Diagrams (Flow Chart), Network Mind Maps, CRM Databases. 
...
1. Native App AR
2. Social AR
3. Web (browser based) AR

### Native App Ar: Pokemon GO
### Social App AR: Optimize for short bursts (15s)
### Web AR: World Tracking, 

### Applications
- QR Code AR for Marketing Campaigns
- Embed into a webpage
- Add 3D to 2D pages, boosting time spent.
- AR Wardrobe - Weat all the clothes so you can see on the web.
