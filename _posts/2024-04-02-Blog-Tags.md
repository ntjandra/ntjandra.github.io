...
6. memo: A focus on my memoirs, a major life event which replaces the me tag. Each name should be 3-5 characters for the button to be clean.
...
2. Add the "tech" tag
3. Add the "trial" tag
4. Add the "story" tag, No posts so far.
5. Remove "learn" tag. Check to see if some can be tech
6. Remove "code" tag
7. Remove "write" tag
